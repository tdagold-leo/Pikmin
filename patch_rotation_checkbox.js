...
const detailsTarget = `<summary style="cursor: pointer; font-size: 14px; color: #94a3b8; outline: none; padding: 5px 0; user-select: none; font-weight: bold;">
                                🔒 私有清單 (點此展開)
                            </summary>`;
const detailsReplacement = `<summary style="cursor: pointer; font-size: 14px; color: #94a3b8; outline: none; padding: 5px 0; user-select: none; font-weight: bold; display: flex; justify-content: space-between; align-items: center;">
                                <span>🔒 私有清單 (點此展開)</span>
                                <span style="font-size: 11px; color: #64748b; font-weight: normal;">☑️ 勾選者參與輪替</span>
                            </summary>`;

const publicDetailsTarget = `<summary style="cursor: pointer; font-size: 14px; color: #94a3b8; outline: none; padding: 5px 0; user-select: none; font-weight: bold;">
                                🌐 公開清單 (點此展開)
                            </summary>`;
const publicDetailsReplacement = `<summary style="cursor: pointer; font-size: 14px; color: #94a3b8; outline: none; padding: 5px 0; user-select: none; font-weight: bold; display: flex; justify-content: space-between; align-items: center;">
                                <span>🌐 公開清單 (點此展開)</span>
                                <span style="font-size: 11px; color: #64748b; font-weight: normal;">☑️ 勾選者參與輪替</span>
                            </summary>`;

indexContent = indexContent.replace(detailsTarget, detailsReplacement);
indexContent = indexContent.replace(publicDetailsTarget, publicDetailsReplacement);
...
console.log('Successfully updated main.js with selective rotation checkbox logic!');
